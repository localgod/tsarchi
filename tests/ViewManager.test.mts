...
describe("ViewManager", () => {
  ...
  describe("addConnection", () => {
    it("should create a connection between diagram objects", () => {
      ...
      const connection = archimate.addConnection(view.id, obj1!.id, obj2!.id, "rel-1", {
        lineColor: "#00ff00",
        lineWidth: 2,
      });
  ...
  describe("generateViewFromElements", () => {
    ...
    it("should generate a view with circular layout", () => {
      const view = archimate.generateViewFromElements("Circular View", ["app-1", "app-2"], {
        layoutType: "circular",
      });
    ...
    it("should include relationship connections when requested", () => {
      const view = archimate.generateViewFromElements("Connected View", ["app-1", "app-2"], {
  ...
  describe("createViewByElementType", () => {
    it("should create a view with all elements of specified type", () => {
      const view = archimate.createViewByElementType(
